                ...
                <tbody>
                    <tr v-for="cliente of lista" v-bind:key="cliente.id_cliente">
                        ...
                        <td>
                            ...
                            <button @click="statsCliente(cliente)" class="btn btn-outline-success btn-sm "><i class="bi bi-patch-check" style="font-size: 0.7rem;"></i></button>
...
export default {
    ...
    methods: {
        ...
        guardarCliente(){
            ...
            this.axios.post("http://192.168.0.39:3000/cliente", unCliente).then(result => {
        ...
        listarClientes(){
            this.axios.get("http://192.168.0.39:3000/clientes").then(result => {
                this.lista = result.data
            })
        },
        eliminarCliente(id){
            this.axios.delete("http://192.168.0.39:3000/cliente/"+id).then(result => {
                alert(result.data)
                this.listarClientes()
            })
        },
        ...
        actualizarCliente(){
            ...
            this.axios.put("http://192.168.0.39:3000/cliente/"+this.id,clientemodificado).then(result => {
                alert(result.data)
                this.listarClientes()
                this.vaciar()
                this.estado = 0;
